...
export default function HomeBanner() {
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12 bg-[#0A0E32] mb-10">
      <Image
        src="/hero.svg"
        alt="Hero"
        width={1572}
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10 md:pl-10">
          ...
          <div className="w-full flex justify-evenly md:justify-start md:gap-3 items-center">
            <Link
              href="#contact"
