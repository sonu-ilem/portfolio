...
export default function Footer() {
    return (
        <>
            <section className="flex flex-col gap-3 bg-blue-50 pb-4 pt-16 md:pt-0">
                ...
                <div className="copyWrite flex justify-center text-gray-500 text-sm">sonukumar @2024</div>
            </section>
        </>
    );
}
